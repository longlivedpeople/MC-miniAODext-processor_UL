...
# with command line options: --python_filename MC-RunIISummer20UL16MiniAODAPVextended_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:RunIISummer20UL16MiniAODAPVextended.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step PAT --geometry DB:Extended --filein file:input.root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n 10
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:RunIISummer20UL16MiniAODAPVextended.root'),
