...
# with command line options: --python_filename MC-RunIISummer20UL18MiniAODv2ext_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:RunIISummer20UL18MiniAODv2ext.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:input.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 10
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:RunIISummer20UL18MiniAODv2ext.root'),
